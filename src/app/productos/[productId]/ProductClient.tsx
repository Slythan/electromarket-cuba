...
export default function ProductPage() {
  ...
  // Se lee el producto por su id: la página funciona aunque se abra desde un enlace directo.
  // Mientras el id consultado no coincida con la ruta, se sigue mostrando "cargando".
  useEffect(() => {
    let active = true;
  ...
  // El administrador puede revisar productos ocultos; los clientes no.
  ...
  // Índice seguro: si el producto cambia, nunca apunta a una foto inexistente.
