  ...
  return <>
    ...
    <footer className="site-footer">
      <div className="site-footer__inner">
        <div className="site-footer__brand"><div className="footer-mark"><img src="/icon.svg" alt="" /><strong>ElectroMarket</strong></div><p>Soluciones confiables para tu hogar, tu energía y tu movilidad en Cuba.</p></div>
