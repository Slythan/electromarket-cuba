...
export default function Shop() {
  ...
  return (
    <div className="container">
      ...
      <StoreHighlights />
      <section className="about-band"><div className="about-band__visual"><div className="about-band__shape">ϟ</div></div><div><span className="eyebrow">COMPRA CON CONFIANZA</span><h2>Tecnología que mejora la vida en Cuba</h2><p>En ElectroMarket seleccionamos productos útiles, duraderos y adaptados a tus necesidades. Nuestro equipo te acompaña con información clara y soporte humano.</p><div className="about-stats"><strong>+2 500<small>clientes</small></strong><strong>100%<small>compra segura</small></strong><strong>Soporte<small>local</small></strong></div></div></section>
    </div>
  );
}