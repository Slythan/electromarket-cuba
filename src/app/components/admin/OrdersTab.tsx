        ...
        <div className="rows">
          {orders.map((o) => (
            <div className="order" key={o.id}>
              ...
              {o.negotiatedTotal != null && <div className="note"><div>Precio negociado: {money(o.negotiatedTotal)}</div><div>Comisión base: {money(o.commissionBase ?? 0)}</div><div>Mensajería: {money(o.deliveryFee ?? 0)}</div><strong>Comisión final: {money(o.commission ?? 0)}</strong></div>}
